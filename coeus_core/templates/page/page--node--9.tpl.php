...
$error_png = '/sites/all/themes/coeus/coeus_core/templates/page/images/404.png';
$error_style = $base_url.$error_css;
$error_image = $base_url.$error_png;
?>
      ...
      <article id="page-content" class="grid_12">
        <div class="wrapper row2">
          <div id="container">
            <section id="fof">
              <div class="fl_left">
                <img src="<?php print $error_image; ?>" alt="">
                <h1>Sorry, Nothing Found</h1>
              </div>
              <div class="fl_right">
                <h2>What Next ?</h2>
                <p>Uh oh! We could not find that page!</p>
                <p>Go back to the <a href="javascript:history.go(-1)">previous page</a> or visit our <a href="<?php print $base_url; ?>">homepage</a>.</p>
              </div>
            </section>
          </div>
        </div>
